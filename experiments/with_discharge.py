...
path_data = '/pfs/data6/home/ka/ka_iwu/ka_as2023/dataset/01_europe_flood/Caravan/' # Caution! using absolute path here as I do not want to save the data together with the code
